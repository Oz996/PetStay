      ...
      <nav className="container mx-auto h-[6.5rem]">
        <ul className="grid grid-cols-2 gap-10 lg:flex justify-between lg:gap-0">
          <li className="flex items-center">
            ...
            <input
              type="text"
              className="rounded-xl border px-3 pl-12 min-h-[3rem] min-w-[17rem] text-lg focus:outline-primary"
          ...
          <button className="bg-secondary min-h-[3rem] w-[6rem] rounded-lg flex justify-center items-center">
