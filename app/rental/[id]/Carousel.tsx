      ...
      {rental.gallery.map((image, index) => (
        ...
        >
          <Image
            ...
            priority={true}
          />
          <div className="absolute bg-gradient-to-t from-black to-transparent opacity-80 left-0 bottom-0 w-full p-3 flex gap-1 text-lg font-semibold justify-center h-[8rem] text-white items-end">
